...
run: ./bin/main.o ./bin/hack.o
	$(CXX) ./bin/main.o ./bin/hack.o -L /opt/homebrew/Cellar/sfml@2/2.6.2_1/lib -lsfml-graphics -lsfml-window -lsfml-system -o main

./bin/main.o: src/main.cpp
	$(CXX) -c ./src/main.cpp -I /opt/homebrew/Cellar/sfml@2/2.6.2_1/include -o ./bin/main.o

./bin/hack.o: src/hack.cpp hpp/hack.hpp
	$(CXX) -c ./src/hack.cpp -o ./bin/hack.o
